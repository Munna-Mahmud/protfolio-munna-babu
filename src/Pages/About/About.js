...
const About = () => {
    return (
        <div id="about" className=" pt-4 mb-2 about-details bg-dark text-white  ">
            <div className="container">
                <div className="row ">
                    ...
                    <div className="col-12 col-md-8 text-start">
                        ...
                        <a target="_blank" className="btn cv_btn text-white" href="https://drive.google.com/file/d/1jNNRpKsb9pB_VPI5Zyc3MguXSstYH4bG/view?usp=sharing">Download CV</a>
